...
function envOverride(m) {
    if ('TRUE' === process.env.BONEQUEST_TEST_LIVE ||
        'TRUE' === process.env.BONEQUEST_TEST_OVERRIDE) {
    ...
    m.BONEQUEST_TEST_EXPLAIN = process.env.BONEQUEST_TEST_EXPLAIN || m.BONEQUEST_TEST_EXPLAIN;
    return m;
}
