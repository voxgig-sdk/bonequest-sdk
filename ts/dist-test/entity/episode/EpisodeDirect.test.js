...
(0, node_test_1.describe)('EpisodeDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.BonequestSDK({
    ...
    (0, node_test_1.test)('direct-load-episode', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-episode', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.BONEQUEST_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.BonequestSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['BONEQUEST_TEST_EPISODE_ENTID'];
    ...
    const client = new __1.BonequestSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=EpisodeDirect.test.js.map