...
(0, node_test_1.describe)('QuoteDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-quote', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-quote', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['BONEQUEST_TEST_QUOTE_ENTID'];
...
//# sourceMappingURL=QuoteDirect.test.js.map