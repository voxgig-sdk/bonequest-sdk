...
`client.Episode()` — each with a small set of operations (`list`, `load`)
...
| Method | Returns | Description |
| --- | --- | --- |
| `BonequestSDK.test(testopts?, sdkopts?)` | `BonequestSDK` | Create a test-mode client. |
...
bonequest/
├── src/
│   ├── BonequestSDK.ts        # Main SDK class
