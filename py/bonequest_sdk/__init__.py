...
from bonequest_sdk.utility import register

# Load features
from bonequest_sdk.feature.base_feature import BonequestBaseFeature
from bonequest_sdk.features import _has_feature, _make_feature
...
class BonequestSDK:
    ...
    def get_utility(self):
        return BonequestUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("BonequestSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Episode(self, data=None) -> "EpisodeEntity":
        ...
        from bonequest_sdk.entity.episode_entity import EpisodeEntity
        return EpisodeEntity(self, data)


    def Quote(self, data=None) -> "QuoteEntity":
        """Entity factory: client.Quote().list() / client.Quote().load({"id": ...})."""
        from bonequest_sdk.entity.quote_entity import QuoteEntity
        return QuoteEntity(self, data)


    def Search(self, data=None) -> "SearchEntity":
        """Entity factory: client.Search().list() / client.Search().load({"id": ...})."""
        from bonequest_sdk.entity.search_entity import SearchEntity
        return SearchEntity(self, data)



    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "BonequestSDK":
        if sdkopts is None:
            sdkopts = {}
