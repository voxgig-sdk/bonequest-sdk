...
from bonequest_sdk.core.helpers import get_ctx_prop, to_map
...
class BonequestContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, BonequestSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, BonequestResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, BonequestResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return BonequestError(code, msg, self)
