# Bonequest SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions BonequestSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both BonequestSDK(...) and BonequestSDK.test(...) become
#      BonequestSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "bonequest_sdk"
_SDK_CLASS = "BonequestSDK"
