...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/bonequest` | `npm install @voxgig-sdk/bonequest` |
| Python | `voxgig-sdk-bonequest` | `pip install voxgig-sdk-bonequest` |
| PHP | `voxgig-sdk/bonequest` | `composer require voxgig-sdk/bonequest` |
| Golang | `github.com/voxgig-sdk/bonequest-sdk/go` | `go get github.com/voxgig-sdk/bonequest-sdk/go` |
| Ruby | `voxgig-sdk-bonequest` | `gem install voxgig-sdk-bonequest` |
| Lua | `voxgig-sdk-bonequest` | `luarocks install voxgig-sdk-bonequest` |
