...
func NewEpisodeEntity(client *core.BonequestSDK, entopts map[string]any) *EpisodeEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *EpisodeEntity) GetName() string { return e.name }
...
func (e *EpisodeEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *EpisodeEntity) Deleted() bool {
	return e.deleted
}


func (e *EpisodeEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewEpisodeEntity(e.client, opts)
}

func (e *EpisodeEntity) Data(args ...any) any {
...
func (e *EpisodeEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *EpisodeEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *EpisodeEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *EpisodeEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *EpisodeEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *EpisodeEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *EpisodeEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
