...
import (
	...
	vs "github.com/voxgig-sdk/bonequest-sdk/go/utility/struct"
)

type QuoteEntity struct {
	name    string
	client  *core.BonequestSDK
...
func NewQuoteEntity(client *core.BonequestSDK, entopts map[string]any) *QuoteEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *QuoteEntity) GetName() string { return e.name }
...
func (e *QuoteEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *QuoteEntity) Deleted() bool {
	return e.deleted
}


func (e *QuoteEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewQuoteEntity(e.client, opts)
}

func (e *QuoteEntity) Data(args ...any) any {
...
func (e *QuoteEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Quote; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *QuoteEntity) DataTyped(data ...Quote) Quote {
	if len(data) > 0 {
		return typedFrom[Quote](e.Data(asMap(data[0])))
	}
	return typedFrom[Quote](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Quote (all fields
// optional at the wire level).
func (e *QuoteEntity) MatchTyped(match ...Quote) Quote {
	if len(match) > 0 {
		return typedFrom[Quote](e.Match(asMap(match[0])))
	}
	return typedFrom[Quote](e.Match())
}
...
func (e *QuoteEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *QuoteEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *QuoteEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// QuoteListMatch and returns []Quote. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *QuoteEntity) ListTyped(reqmatch QuoteListMatch, ctrl map[string]any) ([]Quote, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Quote](res), nil
}



func (e *QuoteEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *QuoteEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *QuoteEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *QuoteEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
