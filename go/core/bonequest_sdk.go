...
func (sdk *BonequestSDK) OptionsMap() map[string]any {
...
func (sdk *BonequestSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *BonequestSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *BonequestSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *BonequestSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *BonequestSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *BonequestSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("BonequestSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *BonequestSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *BonequestSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("BonequestSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *BonequestSDK {
	if sdkopts == nil {
