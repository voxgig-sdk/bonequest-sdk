...
type Args struct {
	Entity string         `json:"entity" jsonschema:"episode | quote | search"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.BonequestSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "bonequest_list",
		Description: "List records from Bonequest. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "bonequest_load",
		Description: "Load a single record from Bonequest. " +
...
func runOp(client *sdk.BonequestSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.BonequestSDK, name string) (sdk.BonequestEntity, error) {
