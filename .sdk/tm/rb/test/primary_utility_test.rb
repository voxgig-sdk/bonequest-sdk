...
class PrimaryUtilityTest < Minitest::Test
  ...
  def setup
    @runner = BonequestOmni.make_runner(TEST_JSON_FILE, BonequestSDK.test(nil, nil))
  ...
  def test_make_point_basic
    ...
    subject = lambda do |ctx|
      ...
      err.nil? ? point : BonequestOmni.errify(err)
    end
