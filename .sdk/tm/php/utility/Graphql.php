...
class BonequestGraphql
{
    ...
    // equivalent.
    public static function body(BonequestContext $ctx): mixed
    {
    ...
    public static function errors(BonequestContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
