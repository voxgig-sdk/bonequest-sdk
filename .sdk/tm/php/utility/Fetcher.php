...
// Bonequest SDK utility: fetcher

class BonequestFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; BonequestSDK/1.0)';
    ...
    public static function call(BonequestContext $ctx, string $fullurl, array $fetchdef): array
    {
