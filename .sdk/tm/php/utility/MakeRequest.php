...
// Bonequest SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class BonequestMakeRequest
{
    public static function call(BonequestContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new BonequestResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new BonequestResponse($fetched);
        } else {
