...
{
    private static function utility(): BonequestUtility
    {
        return new BonequestUtility();
    }
    ...
    private static function ctx(array $over = []): BonequestContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new BonequestContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new BonequestOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof BonequestError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new BonequestOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = BonequestMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new BonequestOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = BonequestMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new BonequestOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = BonequestMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new BonequestSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = BonequestMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new BonequestResponse([]),
            'result' => new BonequestResult([]),
        ]);
        [, $err] = BonequestMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new BonequestSpec([]),
            'response' => null,
            'result' => new BonequestResult([]),
        ]);
        [, $err] = BonequestMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new BonequestSpec(['step' => 's']),
            'response' => new BonequestResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new BonequestResult([]),
        ]);
        [, $err] = BonequestMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new BonequestSpec(['step' => 's']),
            'response' => new BonequestResponse(self::resp(200, ['v' => 1])),
            'result' => new BonequestResult([]),
        ]);
        [, $err] = BonequestMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new BonequestSpec(['step' => 's']),
            'response' => new BonequestResponse(self::resp(200, ['v' => 2])),
            'result' => new BonequestResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        BonequestMakeResponse::call($ctx);
    ...
    {
        $preset = new BonequestResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new BonequestSpec([]),
            'response' => new BonequestResponse([]),
            'result' => new BonequestResult([]),
        ...
        [$got, $err] = BonequestMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new BonequestResult([])]);
        [, $err] = BonequestMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new BonequestSpec([]), 'result' => null]);
        [, $err] = BonequestMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new BonequestSpec(['step' => 's']),
            'result' => new BonequestResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new BonequestOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = BonequestMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new BonequestSpec(['step' => 's']),
            'result' => new BonequestResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new BonequestOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = BonequestMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new BonequestResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new BonequestSpec([]),
            'result' => new BonequestResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = BonequestMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = BonequestMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new BonequestError('boom', 'boom');
        $utility->fetcher = function (BonequestContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new BonequestSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = BonequestMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (BonequestContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = BonequestMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(BonequestResponse::class, $response);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (BonequestContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new BonequestSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = BonequestMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new BonequestResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new BonequestSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = BonequestMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = BonequestMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = BonequestMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new BonequestResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, BonequestDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new BonequestResult(['ok' => false])]);
        $this->expectException(BonequestError::class);
        BonequestDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new BonequestResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', BonequestMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        BonequestMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new BonequestBaseFeature();
        $b = new BonequestBaseFeature();
        BonequestFeatureAdd::call($ctx, $a);
        BonequestFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): BonequestBaseFeature
    {
        $f = new BonequestBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        BonequestFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): BonequestContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new BonequestSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = BonequestPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new BonequestResponse(['headers' => null]),
            'result' => new BonequestResult([]),
        ]);
        BonequestResultHeaders::call($ctx);
