...
class BonequestRbacFeature extends BonequestBaseFeature
{
    ...
    private function _required(BonequestContext $ctx): ?string
    {
    ...
    private function _reject(BonequestContext $ctx, string $required): void
    {
    ...
    private function _track(BonequestContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
