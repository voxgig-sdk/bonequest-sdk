...
// Bonequest SDK ratelimit feature
...
class BonequestRatelimitFeature extends BonequestBaseFeature
{
    ...
    private function _acquire(BonequestContext $ctx): void
    {
    ...
    private function _track(BonequestContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
