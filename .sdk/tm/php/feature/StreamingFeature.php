...
// Bonequest SDK streaming feature
...
class BonequestStreamingFeature extends BonequestBaseFeature
{
    ...
    private function _iterate(BonequestResult $result): \Generator
    {
    ...
    private function _streamable(BonequestContext $ctx): bool
    {
