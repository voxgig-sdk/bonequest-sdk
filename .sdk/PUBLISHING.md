...
|---|---|---|
| `ts/` | @voxgig-sdk/bonequest-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/bonequest-sdk \
      --repository voxgig-sdk/bonequest-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/bonequest-sdk` shows it, and
`npm trust revoke @voxgig-sdk/bonequest-sdk --id=<id>` removes it.
