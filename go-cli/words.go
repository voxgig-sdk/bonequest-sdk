...
func registerSDKWords(r *eng.Registry, client *sdk.BonequestSDK) {
...
func runOp(client *sdk.BonequestSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
