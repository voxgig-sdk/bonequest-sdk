...
AQL-driven CLI and REPL for the Bonequest SDK. Positional arguments are
...
./bonequest-cli list episode
./bonequest-cli load 1 episode
./bonequest-cli load '{id:1}' episode
