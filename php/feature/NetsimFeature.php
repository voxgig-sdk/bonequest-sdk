...
class BonequestNetsimFeature extends BonequestBaseFeature
{
    ...
    private function _simulate(BonequestContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(BonequestContext $ctx, array $applied): void
    {
        $client = $this->client;
