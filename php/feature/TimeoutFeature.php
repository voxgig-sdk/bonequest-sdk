...
class BonequestTimeoutFeature extends BonequestBaseFeature
{
    ...
    private function _with_timeout(BonequestContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(BonequestContext $_ctx, float $ms): void
    {
        $client = $this->client;
