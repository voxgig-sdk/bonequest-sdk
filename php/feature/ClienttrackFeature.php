...
// Bonequest SDK clienttrack feature
...
class BonequestClienttrackFeature extends BonequestBaseFeature
{
    ...
    public function PostConstruct(BonequestContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Bonequest-SDK';
