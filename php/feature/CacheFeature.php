...
class BonequestCacheFeature extends BonequestBaseFeature
{
    ...
    private function _through(BonequestContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
