...
class BonequestProxyFeature extends BonequestBaseFeature
{
    ...
    public function init(BonequestContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (BonequestContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
