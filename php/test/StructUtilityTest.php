...
// Bonequest SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = BonequestOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(BonequestOmni::structfix($now, Struct::undef()))
                        !== json_encode(BonequestOmni::structfix($val, Struct::undef()))) {
