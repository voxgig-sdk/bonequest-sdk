...
class BonequestTestRunner
{
    ...
    {
        $live = self::getenv('BONEQUEST_TEST_LIVE');
        $override = self::getenv('BONEQUEST_TEST_OVERRIDE');
        ...
        $explain = self::getenv('BONEQUEST_TEST_EXPLAIN');
...
class_alias('BonequestTestRunner', 'Runner');
class_alias('BonequestHelpers', 'Helpers');
