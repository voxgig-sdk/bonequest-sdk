...
// Bonequest SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (BonequestSDK::test)
...
{
    private const SDK_CLASS = 'BonequestSDK';
    ...
    private const SDK_BASE = 'bonequest_sdk';
