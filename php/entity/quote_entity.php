...
class QuoteEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new QuoteEntity($this->_client, $opts);
    }

    /**
     * @param Quote|array $args Quote data (assoc-array) to store.
     */
    ...
    /**
     * @return Quote|array The current Quote data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Quote fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Quote fields).
     */
    ...
    /**
     * List Quote items matching the given filter.
     *
     * @param QuoteListMatch|array|null $reqmatch Match filter (any subset
     *   of Quote fields) as an assoc-array; QuoteListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Quote[]|array A list of Quote items as assoc-arrays at
     *   the SDK boundary; throws BonequestError on failure (item-5 convention).
     */
