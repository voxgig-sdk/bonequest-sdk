...
describe("EpisodeDirect", function()
  it("should direct-load-episode", function()
    local setup = episode_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-episode", setup.live and "live" or "unit")
...
function episode_direct_setup(mockres)
