...
describe("QuoteDirect", function()
  it("should direct-list-quote", function()
    local setup = quote_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-quote", setup.live and "live" or "unit")
...
function quote_direct_setup(mockres)
