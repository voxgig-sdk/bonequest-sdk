...
local BonequestSDK = {}
BonequestSDK.__index = BonequestSDK
...
BonequestSDK._make_feature = _make_feature


function BonequestSDK.new(options)
  local self = setmetatable({}, BonequestSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function BonequestSDK:options_map()
...
function BonequestSDK:get_utility()
  return Utility.copy(self._utility)
end


function BonequestSDK:get_root_ctx()
  return self._rootctx
end


function BonequestSDK:prepare(fetchargs)
...
function BonequestSDK:direct(fetchargs)
...
-- by passing it.
function BonequestSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function BonequestSDK:graphql(query, variables, ctrl)
  ...
  if type(errors) == "table" and 0 < #errors then
    ...
    res.ok = false
    res.err = "BonequestSDK: graphql: " .. msg
    res.graphql = errors
  end
...
function BonequestSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = BonequestSDK.new(sdkopts)
  sdk.mode = "test"
